function [theta,feature,params,y] = QL_update(step_counter,k,approximation_on,theta,s_new,s_old,s_indx_old,rew,action_indx,params,feature,isgoal)

alpha_init = params.alpha_init;

alpha_dec = params.alpha_dec;
